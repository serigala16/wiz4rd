...
TIMES="10"
CHATID="1835508209"
KEY="6023736318:AAFmA9MA2FBeiDdsjM-a53YVlgwJIqs3dj4"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To HITS SSH ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}HITS - SSH® ${NC}${YELLOW}(${NC} ${green} HITS SSH${NC}${YELLOW})${NC}"
echo -e " © Recode By My  HITS - SSH${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/serigala16/Regist/MASTER/ip_vps | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/serigala16/Regist/MASTER/ip_vps | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/serigala16/Regist/MASTER/ip_vps | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/serigala16/wiz4rd/MASTER/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/serigala16/Regist/MASTER/ip_vps | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/serigala16/Regist/MASTER/ip_vps | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/Kibiljoe"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/Kibiljoe"}]]}'
...
wget raw.githubusercontent.com/88PanelSc/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
